...
data = pd.read_csv("C:/Users/Marco/PycharmProjects/IC/dataset/data.csv")
datas = data.drop('filename', 1)
X = np.array(datas.drop('label', 1))
y = np.array(data['label'])
X_train, X_test, Y_train, Y_test, n_class = dataFunctions.getData("C:/Users/Marco/PycharmProjects/IC/dataset/data.csv")
