...
X_train, X_test, Y_train, Y_test, n_class = dataFunctions.getData("D:/Users/Marco/Desktop/DataSet/musicfeatures/data.csv")


data.hist(bins=50, figsize=(25, 20))
plt.show()

print(statistics.mean(data.skew()))
print("--------------")
print(statistics.mean(data.kurt()))
